    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            function addFile(file) {
                ...
                if (file.getStatus() === 'invalid') {
                    ...
                    if ('|png|jpg|jpeg|bmp|gif|'.indexOf('|'+file.ext.toLowerCase()+'|') == -1) {
                        $wrap.empty().addClass('notimage').append('<i class="admin-preview admin-type-' + file.ext.toLowerCase() + '"></i>' +
                            '<span class="admin-title">' + file.name + '</span>');
                    } else {
            ...
            function removeFile(file) {
                ...
                updateTotalProgress();
                $li.off().find('.admin-panel').off().end().remove();
            }
